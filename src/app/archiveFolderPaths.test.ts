...
describe("archive folder paths", () => {
  ...
  test("keeps a softly rounded open folder shape as the animation target", () => {
    expect(getArchiveFolderPaths(1)).toEqual({
      top:
        "M4.65 5.55c0-.72.58-1.3 1.3-1.3h3.18c.38 0 .74.17 .99.45l1.35 1.55h6.58c.72 0 1.3.58 1.3 1.3v1.05H7.95c-1.02 0 -2 .54 -2.58 1.5l-.68 1.12V5.55Z",
      front:
  ...
  test("interpolates coordinates between the closed and open folder shapes", () => {
    expect(getArchiveFolderPaths(0.5)).toEqual({
      top:
        "M4.65 5.55c0-.72.58-1.3 1.3-1.3h3.18c.38 0 .74.17 .99.45l1.35 1.55h6.58c.72 0 1.3.58 1.3 1.3v1.05H6.3c-.51 0 -1 .27 -1.29 .75l-.34 .56V5.55Z",
      front:

...
const OPEN_FRONT: readonly number[] = [
  7.1, 10.8, 13.55, 0.92, 0, 1.48, 0.82, 1.15, 1.66, -1.45, 4.58, -0.36,
  1.06, -1.08, 2.62, -2.2, 2.62, 18.15, 19.66, 5.5, -0.96, 0, -1.58,
  -0.92, -1.21, -1.82, 1.42, -4.18, 0.4, -1.22, 0.82, -2.86, 1.39, -2.86,
];

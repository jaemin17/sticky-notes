...
const OPEN_FRONT: readonly number[] = [
  6.86, 10.84, 13.58, 0.82, 0, 1.42, 0.62, 1.25, 1.42, -1.15, 4.58, -0.24,
  1.02, -1.12, 2.54, -2.38, 2.62, 18.16, 19.46, 5.72, -1.1, 0, -1.82,
  -0.8, -1.56, -1.78, 1.15, -4.58, 0.2, -0.9, 0.82, -1.76, 1.5, -2.16,
];
